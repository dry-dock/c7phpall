...
PHP_BUILD_CONFIGURE_OPTS="--with-bz2 --enable-intl --enable-zip --without-libzip --with-ldap=/usr/include" php-build -i development "$PHP_VERSION" $HOME/.phpenv/versions/7.3
